// Copyright (c) 2014 The IncognitoCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("incognitocoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("incognitocoin-smsg-pow"); // Make this thread recognisable
